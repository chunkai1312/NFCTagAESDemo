...
public class TagReaderActivity extends NfcReaderActivity {
    ...
    private static final String ACTION = "edu.ntust.cs.idsl.nfctagaesdemo.action.READ_TAG";
...
//            ToastMaker.toast(this, R.string.readSingleRecordNDEFMessage);
        ...
        setResult(Activity.RESULT_OK, TagReaderFragment.getIntentForResult(type, maxSize, message));
        finish();
    }
